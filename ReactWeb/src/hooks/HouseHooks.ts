...
//usequery is used with axios to fecth data corecxtly and when any instacne 
//in our database changes it refetches data again
//npm install axios@1 @tanstack/react-query@5
//have to setup some setting in our main.tsx file
